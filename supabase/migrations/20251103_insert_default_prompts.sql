-- Script SQL: Insertion des prompts par défaut
-- IMPORTANT: Remplacer 'VOTRE_USER_ID' par votre vrai user_id (UUID depuis auth.users)
-- Pour obtenir votre user_id: SELECT id FROM auth.users WHERE email = 'votre@email.com';

-- 1. Prompt Système (principal)
INSERT INTO ai_prompts (key, title, content, user_id) VALUES (
'prompt_system',
'Prompt Système',
'# Prompt Système - BatiPilot Assistant
...
-- 2. Détails du Projet
INSERT INTO ai_prompts (key, title, content, user_id) VALUES (
'prompt_details_projet',
'Détails du Projet',
'# Prompt: Détails du Projet
...
INSERT INTO ai_prompts (key, title, content, user_id) VALUES (
'prompt_formats_donnees',
'Formats de Données',
'# Prompt: Formats de Données
...
-- 4. Actions Sociétés
INSERT INTO ai_prompts (key, title, content, user_id) VALUES (
'prompt_actions_societes',
'Actions Sociétés',
'# Prompt: Actions Sociétés
...
-- 5. Actions Clients
INSERT INTO ai_prompts (key, title, content, user_id) VALUES (
'prompt_actions_clients',
'Actions Clients',
'# Prompt: Actions Clients
