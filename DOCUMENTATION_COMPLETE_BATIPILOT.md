...
*(La suite de la documentation sera dans le prochain message car nous approchons de la limite de caractères. Je continue immédiatement avec les modules Facturation, Comptabilité, PDF, etc.)*

Voulez-vous que je continue maintenant avec la suite ?
